    ...
    <section className="flex-1 bg-black flex items-center justify-center relative">
      ...
      <div className="relative w-full h-full flex items-center justify-center p-8">
        <div className="relative" style={{ transform: `scale(${zoom})`, transition: 'transform 0.2s' }}>
          ...
          {/* Legendas */}
          {currentSubtitle && (
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-center max-w-[90%]">
              <p 
                className="text-sm font-semibold leading-relaxed text-white font-montserrat"
