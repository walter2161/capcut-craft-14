  ...
  return (
    <footer className="h-52 bg-[hsl(var(--timeline-bg))] border-t border-border flex flex-col">
      ...
      <div className="flex-1 overflow-x-auto overflow-y-hidden relative">
            ...
            {videoClips.map(clip => {
              ...
              return (
                <div
                  ...
                  className={`absolute h-10 top-2 rounded cursor-pointer transition-all ${
        ...
        {/* Playhead */}
        <div
          className="absolute top-0 bottom-0 w-0.5 bg-[hsl(var(--playhead))] pointer-events-none z-10"
          style={{
            left: `${80 + currentTime / MS_PER_PIXEL}px`,
          }}
        >
          <div className="w-3 h-3 bg-[hsl(var(--playhead))] rounded-full -ml-1.5 -mt-1" />
        </div>
      </div>
    </footer>
  );
